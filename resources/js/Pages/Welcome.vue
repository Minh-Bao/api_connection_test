    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="flex justify-center bg-white">
                <Link :href="route('user.index')" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-indigo-400 dark:hover:text-indigo focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Click here for the Ar24 users index page</Link>
            </div>
